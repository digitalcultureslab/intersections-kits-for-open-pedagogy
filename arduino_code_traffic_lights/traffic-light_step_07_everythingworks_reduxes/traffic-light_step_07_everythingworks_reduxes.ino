...
void loop() 
{
  ...
  // this is the wait between shift from red to green - intersection to clear
  // could also just set all to low:
  // digitalWrite(YELLOW, LOW);
  // digitalWrite(RED, LOW);
  // digitalWrite(GREEN, LOW);
  // delay(DELAY_INTERSECTION) - would need to add this to variables list above with ms value
  //
 
  
  digitalWrite(GREEN, LOW);    // sets the LED off - to wait between switch from red
  delay(DELAY_GREEN_01); // waits 
  digitalWrite(GREEN, LOW);    // sets the LED off - to wait between switch from red
